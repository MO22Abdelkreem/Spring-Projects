...
public class DoctorAPI {
    ...
    public ResponseEntity<DoctorDTO> uploadDoctorImage(@PathVariable Long id, @RequestParam("file") MultipartFile file)
    {
        DoctorDTO updatedDoctor = doctorService.updateDoctorImage(id, file);
